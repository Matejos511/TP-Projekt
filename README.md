...
Zaradi časovne omejenosti in zahtevnosti tega projekta se bom omejil le na prevokotnik, ki ga lahko jasno vidite na sliki. Torej izdelal bom aplikacijo, ki komunicira z LLM modelom in nato še TTS preko API in ju tako povežeskupaj v eno.  
