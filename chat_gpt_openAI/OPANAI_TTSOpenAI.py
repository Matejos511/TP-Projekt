...
from openai import OpenAIClient  # Assuming this is your OpenAI client
...
def send_message():
    ...
    try:
        completion = client.chat.completions.create(
            model="gpt-4o",
            messages=[{"role": "system", "content": "You are France Prešeren."},
    ...
    # Read the assistant's response aloud using TTS
